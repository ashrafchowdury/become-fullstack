                ...
                <CardContent>
                  ...
                  >
                    <div className="space-y-1 relative">
                      ...
                      <User2 className="w-4 h-4 absolute bottom-[11px] left-[10px]" />
                      <Input
                        type="text"
                    ...
                    <div className="space-y-1 relative">
                      ...
                      <Mail className="w-4 h-4 absolute bottom-[10px] left-[11px]" />
                      <Input
                        type="email"
                    ...
                    <div className="space-y-1 relative">
                      ...
                      <LockIcon className="w-4 h-4 absolute bottom-[11px] left-[10px]" />
                      <Input
                        type="password"
            ...
            <TabsContent value="forget">
              <Card>
                ...
                <CardContent>
                  ...
                  >
                    <Label htmlFor="email">Email</Label>
                    <Mail className="w-4 h-4 absolute top-[34px] left-[11px]" />
                    <Input
                      type="email"
                      placeholder="Email Addrese"
                      className="px-9"
